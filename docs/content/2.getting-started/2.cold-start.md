...
Read `detected` before you write anything. If `adapter` is not what you expected,
[pin it](/frameworks/detection) now rather than working around a bad guess for the
rest of this page.
